...
class TestBoardCreation:
    def test_construction_with_kwargs(self):
        board = Board(**DEFAULT_ALLOWED_ARGS)

        assert board.boardId == DEFAULT_ALLOWED_ARGS['boardId']
