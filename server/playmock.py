...
print( mock.searchItem.call_count ) # method that does not exist on mongodb

# mock objects by default can spwan any method/attribute on its instance,
# making it difficult to track broken tests due to typos,
# or keeping up with changing api/interface specifications
# to prevent this, we can create mock by auto-speccing an object
# auto-specced mock would force users of the mock to comply to the interface of the original object

mock = create_autospec(MongoDB)
